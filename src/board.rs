...
impl Board {
    ...
    pub fn place(&mut self, coord: Coord, color: Tile) -> Result<(), String> {
    ...
    pub fn get_captures(&self, coord:Coord, color:Tile) -> Option<HashSet<Coord>> {
...
pub fn neighbors(coord:Coord) -> Vec<Coord> {
